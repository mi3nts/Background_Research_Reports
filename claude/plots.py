...
design_group = {
    ...
    # added 2026-08-07 - 6th recurrence of the unmapped-design fall-through
    "Distributed-lag time-series": "Observational - acute",
    "Burden estimation (GBD)": "Modelling / inventory",
    "Satellite remote sensing": "Modelling / inventory",
    "Monitoring-record analysis": "Measurement campaign",
    "Sensor deployment (pilot)": "Measurement campaign",
    "Biomonitoring transplant": "Measurement campaign",
    "Cross-sectional survey": "Observational - cross-sectional",
    "Toxicological (in vitro)": "Experimental / toxicology",
    "Materials / filtration": "Chamber / laboratory",
    "Literature review": "Tool / software",
...
GEO_SUBSTR = [
    ...
    ("argentina", "Argentina"), ("san juan", "Argentina"),
